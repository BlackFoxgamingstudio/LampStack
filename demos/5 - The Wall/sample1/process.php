<?php
	...
	function post_action()
	{
		if(!empty($_POST['post']))
		{
			$insert_post_query = "INSERT INTO posts (user_id, content, created_at) VALUES ('". $_SESSION['user']['id'] ."', '". $_POST['post'] ."', NOW()) ";
	...
	function comment_action()
	{
		...
		{
			$insert_comment_query = "INSERT INTO comments (user_id, post_id, content, created_at) VALUES('". $_SESSION['user']['id'] ."', '". $_POST['post_id'] ."', '". $_POST['comment'] ."', NOW()) ";
