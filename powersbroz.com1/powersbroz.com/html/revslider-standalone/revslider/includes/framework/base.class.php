...
class RevSliderBase {
	...
	protected static $is_multisite = false;
	...
	public function __construct($t){
		...
		self::$url_ajax = site_url('c=admin&m=ajax');
	...
	public static function get_image_id_by_url($image_url) {
		...
		if ( 0 == $attachment_id ){ //try to get it old school way
			...
			if ( false !== strpos( $image_url, $upload_dir_paths['baseurl'] ) ) {
				...
				// NWD update for getting image in standalone version
				$attachment_id = get_image_id_by_url( $image_url );
