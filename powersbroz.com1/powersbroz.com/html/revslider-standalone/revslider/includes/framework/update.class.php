...
class RevSliderUpdate {
	...
	private $plugin_url			= 'http://revolution.themepunch.com/jquery-visual-editor-addon'; //Change after first update
	private $remote_url			= 'http://updates.themepunch.tools/check_for_updates.php';
	private $remote_url_info	= 'http://updates.themepunch.tools/revslider-js-addon/revslider-standalone.php';
