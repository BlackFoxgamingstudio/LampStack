...
<div class='wrap'>
	...
	<div class="title_line" style="margin-bottom:10px">
		<a href="<?php echo self::getViewUrl("sliders");?>"><div id="icon-options-general" class="icon32"></div></a>
			...
			<div class="rs-dash-widget-inner" style="width:233px; display:inline-block">
				...
				<?php if(!RS_DEMO){ ?>
					...
					<?php if ($js_validated === 'true') { 
							...
							?>
							<span class="rs-dash-button-gray"><?php _e('Register for Update', 'revslider'); ?></a>				
							<?php
						}	
						?>			
					</div>
