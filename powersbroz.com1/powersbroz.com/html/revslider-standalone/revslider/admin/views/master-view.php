...
<script type="text/javascript">
	...
	var g_urlMediaGallery = '<?php echo site_url('c=media'); ?>';
	var g_urlMediaUpload = '<?php echo site_url('c=media&m=index&f=upload_file'); ?>';
	var g_urlMediaAjax = '<?php echo site_url('c=media&m=index&f=ajax_list'); ?>';
