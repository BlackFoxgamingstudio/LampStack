...
define('GOTEO_DB_HOST', 'internal-db.s212369.gridserver.com');
define('GOTEO_DB_PORT', 3306);
define('GOTEO_DB_CHARSET', 'UTF-8');
define('GOTEO_DB_SCHEMA', 'db212369_crowdfunder');
define('GOTEO_DB_USERNAME', 'db212369');
define('GOTEO_DB_PASSWORD', 'PowersBros45me');
...
define('SITE_URL', 'www.powersbroz.com/GOTEO'); // endpoint url
define('SRC_URL', 'www.powersbroz.com/GOTEO');  // host for statics
define('SEC_URL', 'www.powersbroz.com/GOTEO');  // with SSL certified
...
define("internal-db.s212369.gridserver.com", "beta");
