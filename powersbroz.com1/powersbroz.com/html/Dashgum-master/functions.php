...
class DB {
 ...
 function __construct() {
		...
		$database = "db212369_calteta";
		$con = new mysqli($host, $user, $password,$database)or die("not connected");
	...
	public function getorder($table, $condition, $orderby) {
		...
		$cnd = $condition;
		$oby = $orderby;
                $query=mysqli_query("select * from $this->table where $cnd ORDER BY $oby")or die("error in get") ;
		return $query;
