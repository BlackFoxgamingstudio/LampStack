...
window.Codo = function(a) {
    ...
    return a && ("string" == typeof a ? b = document.querySelectorAll(a) : b.push(a)), {
        ...
        script: function(a, b, c) {
            ...
            d.type = "text/javascript", d.async = !0, d.onreadystatechange = function(a) {
                "complete" != this.readyState && "loaded" != this.readyState || a || (b && b(c), a = !0)
            }, d.onload = function() {
                b && b(c)
            }, d.onerror = function() {
                b && b("error")
        ...
        load: function(a, c) {
            ...
            d.open(a.action || "GET", a.url, !0), d.onreadystatechange = function() {
                if (4 === this.readyState)
                    if (this.status >= 200 && this.status < 400) {
                        if (!b[0]) return c(this.responseText), this.responseText;
        ...
        remove: function() {
            if (b[0])
                for (var a = 0; a < b.length; a++) b[a].parentNode.removeChild(b[a])
        },
        addClass: function(a) {
            if (b[0])
    ...
    function d() {
        ...
        var d = Codo().isTouch() ? "touchstart" : "click",
            ...
            C = function(a) {
                ...
                function f() {
                    ...
                    for (var b = Codo(g).add({
                        ...
                        e.setAttribute("data-row", c), f.setAttribute("data-row", c), i.setAttribute("data-row", c), Codo(e).on(d, function(b) {
                            ...
                            a.system.initClickMade = !0, a.playlist.next(c.getAttribute("data-row"), "autoplay"), Codo().isTouch() && a.media.play()
                        })
                    }
                ...
                var g, h = {
                    ...
                    currentIndex: "0",
                    set: function(a, d) {
                        this.currentIndex = "0", this.clips = b(a);
                        for (var e = 0; e < this.clips.length; e++) this.clips[e].srcHD && (this.clips[e].srcHD = c(this.clips[e].srcHD));
            ...
            M = new g(b),
            N = new H(M);
        Codo().link(M.system.rootPath + "styles/" + M.settings.style + "/style.css");
        ...
        for (var Y in M.plugins) M.plugins[Y] && !Codo().getScriptTag("codo-player-" + Y + ".js") && Codo().script(M.system.rootPath + "plugins/" + Y + "/codo-player-" + Y + ".js", function() {}, M);
        return M.playlist = new C(M), M.playlist.set(a, M.settings.autoplay), M.onReady && M.onReady(M), M
    }
