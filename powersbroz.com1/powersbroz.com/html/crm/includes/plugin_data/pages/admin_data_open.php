...
<?php if($show_incident_menu){ ?> 
// hacky tabs classes:
$('.custom_data_nav_wrap').addClass('ui-tabs ui-corner-all'); //ui-widget-content ui-widget
$('.custom_data_nav').addClass('ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all');
$('.custom_data_nav li').addClass('ui-state-default ui-corner-top');
$('.custom_data_nav li.link_current').addClass('ui-tabs-selected ui-state-active');
<?php } ?> 
$('.custom_data_wrapper').addClass('ui-tabs-panel ui-corner-bottom'); //ui-widget-content
