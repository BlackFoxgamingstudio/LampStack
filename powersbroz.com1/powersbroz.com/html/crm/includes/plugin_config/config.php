...
/*
    ...
    public function get_install_sql(){
        ...
        INSERT INTO `<?php echo _DB_PREFIX;?>config` SET `key` = '_installation_code', `val` = '893ecafa-6fb9-4299-930f-7526a262c4e8';
        <?php /* default email settings from the installer: */ 
 self::$_c['admin_email_address'] = 'blackfoxgamingstudio@gmail.com' 
 ?> 
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'admin_email_address', `val` = 'blackfoxgamingstudio@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'customer_signup_admin_email', `val` = 'blackfoxgamingstudio@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'error_email_address', `val` = 'blackfoxgamingstudio@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_from_email', `val` = 'blackfoxgamingstudio@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_bounce', `val` = 'blackfoxgamingstudio@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'ticket_admin_email_alert', `val` = 'blackfoxgamingstudio@gmail.com';
