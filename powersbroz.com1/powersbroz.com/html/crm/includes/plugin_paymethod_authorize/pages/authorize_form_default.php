<style type="text/css">
	...
	/* Style Select Boxes */
	span.customStyleSelectBox { -moz-box-shadow: 0 0 4px -1px rgba(0, 0, 0, 0.2); -webkit-box-shadow: 0 0 4px -1px rgba(0, 0, 0, 0.2); box-shadow: 0 0 4px -1px rgba(0, 0, 0, 0.2);cursor: pointer; padding: 8px; background-color: #f7f7f7; border: 1px solid #d4d4d4; color: #717171; -moz-border-radius: 5px; -webkit-border-radius: 5px;border-radius: 5px 5px; line-height: 11px; width: 100% !important }
...
<div id="credit-card">
    <div class="table form-fields">
        ...
        <div class="row">
            ...
            <div class="input full"><input type="text" name="address" id="address" value="{ADDRESS_LINE_1}{ADDRESS_LINE_2}"/></div>
            <div class="valid"></div>
        </div>
        <div class="row">
