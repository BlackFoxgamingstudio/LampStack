              ...
              <div class="ideas-item">
                  ...
                  <div class="details">
                      ...
                      <div class="entry-meta">
                          ...
                          <span class="entry-money"><i class="fa fa-money"></i> <?php _e('Investment:', 'themeum')?> <strong><?php echo themeum_get_currency_symbol(); ?><?php echo esc_attr($funding_goal); ?></strong></span>
                      </div>
                  </div>
              </div> <!--/.ideas-item-->
          </div> <!--/.col-sm-4-->
