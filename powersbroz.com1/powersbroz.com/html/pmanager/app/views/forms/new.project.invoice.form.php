...
$project = Project::find('id', $con->secure($_GET['project']));
?>
<form id="createInvoice" action="./" method="post">
    <input type="hidden" name="create" value="invoice"/>
    <input type="hidden" name="iproject" value="<?= $project->id();?>"/>
    <div class="row">
        <div class="col-md-12">
...
<script>
    ...
    $.get('<?= BASE_URL;?>app/collections/project.members.unique.php', {project: <?= $project->id();?>}, function(data) {
