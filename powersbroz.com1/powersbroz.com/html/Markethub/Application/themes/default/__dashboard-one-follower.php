<div class="onefollower">
    ...
    <div class="info">
        ...
        <div class="moreinfo"><?php echo $D->f_numitems==1?$this->lang('dashboard_followers_hasphoto', array('#NUM#'=>$D->f_numitems)):$this->lang('dashboard_followers_hasphotos', array('#NUM#'=>$D->f_numitems)); ?></div>
    </div>
    <div class="sh"></div>
