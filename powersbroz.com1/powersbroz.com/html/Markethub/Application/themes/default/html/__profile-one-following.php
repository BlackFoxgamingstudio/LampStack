<div class="onefollower">
    ...
    <div class="info">
        ...
        <div class="moreinfo"><?php echo $D->f_numitems==1?$this->lang('profile_following_hasphoto', array('#NUM#'=>$D->f_numitems)):$this->lang('profile_following_hasphotos', array('#NUM#'=>$D->f_numitems)); ?></div>
    </div>
    <div class="sh"></div>
