<div class="oneactivity">
	...
	<div class="oabody">
    	...
    	<div class="space04"><span class="linkblue2"><a href="<?php echo $C->SITE_URL.$D->f_username?>/photos"><?php echo ($D->f_numitems==1?$this->lang('profile_activities_hasphoto', array('#NUM#'=>$D->f_numitems)):$this->lang('profile_activities_hasphotos', array('#NUM#'=>$D->f_numitems)))?></a></span></div>
    </div>
</div>