<div class="oneactivity">
	...
	<div class="oabody">
        ...
        <div class="space04 mrg5T">
        	<div class="line1"><span><?php echo $this->lang('dashboard_activities_inalbum')?></span></div>
            <div class="line2 linkblue2"><a href="<?php echo $C->SITE_URL.$D->userName.'/items/folder/'.$D->codeAlbum?>"><?php echo $D->nameAlbum?></a></div>
        </div>
    	<div class="space05">
