...
if ( ! function_exists( 'tokopress_customizer_library_get_font_choices' ) ) :
/**
 ...
 */
function tokopress_customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'tokopress' ) ) ) );
	$standard_fonts = tokopress_customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'tokopress' ) ) ) );
	$google_fonts   = tokopress_customizer_library_get_google_fonts();
	 ...
	 */
	return apply_filters( 'tokopress_customizer_library_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;
 ...
 * @return array    The fonts in value/label pairs.
 */
function tokopress_customizer_library_get_font_choices() {
	$fonts   = tokopress_customizer_library_get_all_fonts();
	$choices = array();
...
if ( ! function_exists( 'tokopress_customizer_library_get_google_font_uri' ) ) :
/**
 ...
 */
function tokopress_customizer_library_get_google_font_uri( $fonts ) {

	// De-dupe the fonts
	$fonts         = array_unique( $fonts );
	$allowed_fonts = tokopress_customizer_library_get_google_fonts();
	$family        = array();
	...
	foreach ( $fonts as $font ) {
		...
		if ( array_key_exists( $font, $allowed_fonts ) ) {
			...
			$family[] = urlencode( $font . ':' . join( ',', tokopress_customizer_library_choose_google_font_variants( $font, $allowed_fonts[ $font ]['variants'] ) ) );
		}
	}
	...
	if ( 'all' === $subset ) {
		$subsets_available = tokopress_customizer_library_get_google_font_subsets();
...
if ( ! function_exists( 'tokopress_customizer_library_get_google_font_subsets' ) ) :
/**
 ...
 */
function tokopress_customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'tokopress' ),
		'cyrillic'     => __( 'Cyrillic', 'tokopress' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'tokopress' ),
		'devanagari'   => __( 'Devanagari', 'tokopress' ),
		'greek'        => __( 'Greek', 'tokopress' ),
		'greek-ext'    => __( 'Greek Extended', 'tokopress' ),
		'khmer'        => __( 'Khmer', 'tokopress' ),
		'latin'        => __( 'Latin', 'tokopress' ),
		'latin-ext'    => __( 'Latin Extended', 'tokopress' ),
		'vietnamese'   => __( 'Vietnamese', 'tokopress' ),
	);
}
endif;

if ( ! function_exists( 'tokopress_customizer_library_choose_google_font_variants' ) ) :
/**
 ...
 */
function tokopress_customizer_library_choose_google_font_variants( $font, $variants = array() ) {
	$chosen_variants = array();
	if ( empty( $variants ) ) {
		$fonts = tokopress_customizer_library_get_google_fonts();
	...
	return apply_filters( 'tokopress_customizer_library_font_variants', array_unique( $chosen_variants ), $font, $variants );
}
endif;

if ( ! function_exists( 'tokopress_customizer_library_get_standard_fonts' ) ) :
/**
 ...
 */
function tokopress_customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'tokopress' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'tokopress' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'tokopress' ),
...
if ( ! function_exists( 'tokopress_customizer_library_get_font_stack' ) ) :
/**
 ...
 */
function tokopress_customizer_library_get_font_stack( $font ) {

	$all_fonts = tokopress_customizer_library_get_all_fonts();

	// Sanitize font choice
	$font = tokopress_customizer_library_sanitize_font_choice( $font );
...
if ( ! function_exists( 'tokopress_customizer_library_sanitize_font_choice' ) ) :
/**
...
function tokopress_customizer_library_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		...
		return '';
	} else if ( array_key_exists( $value, tokopress_customizer_library_get_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
if ( ! function_exists( 'tokopress_customizer_library_get_google_fonts' ) ) :
/**
 ...
 */
function tokopress_customizer_library_get_google_fonts() {
	return apply_filters( 'tokopress_customizer_library_get_google_fonts', array(
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
				'regular',
