...
add_shortcode( 'eventica_events_venue', 'eventica_shortcode_events_venue' );
function eventica_shortcode_events_venue( $atts ) {
	...
	if ( !trim($title_text) )
		$title_text = __( 'Events Venue', 'tokopress' );
...
add_action( 'vc_before_init', 'eventica_vc_events_venue' );
function eventica_vc_events_venue() {
	vc_map( array(
	   'name'				=> __( 'Eventica - Events Venue', 'tokopress' ),
	   'base'				=> 'eventica_events_venue',
	   'class'				=> '',
	   'icon'				=> '',
	   'category'			=> 'Eventica',
	   'admin_enqueue_js' 	=> '',
	   ...
	   'params'				=> array(
								...
								array(
									...
									'description'	=> __( 'Default:', 'tokopress' ).' '.__( 'Events Venue', 'tokopress' ),
